...
public class ClientListenerThread extends Thread {
    ...
    private void handleMessageType(String messageType, JsonObject jsonObject, UIHandler uiHandler) {
        switch (messageType) {
            ...
            case "LOGIN_FAILED", "SIGNUP_FAILED" , "ROOM_JOIN_FAILED", "REFRESH_HOME_FAILED", "ROOM_CREATE_FAILED", "AUTHOR_APPLY_FAILED" -> uiHandler.showAlertModal(
                    null, "경고", jsonObject.get("content").getAsString(), JOptionPane.ERROR_MESSAGE);
            case "ID_INVALID", "ID_VALID", "NICKNAME_INVALID", "NICKNAME_VALID", "AUTHOR_APPLY_SUCCESS"-> uiHandler.showAlertModal(
